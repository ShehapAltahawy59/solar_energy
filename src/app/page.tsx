...
const ContactButtons = () => {
  ...
  return (
    <div
      className="fixed left-0 top-[80%] -translate-y-1/2 z-50 flex flex-col gap-4"
      dir="ltr"
    >
      <a href="tel:01065690807" className="group flex items-center">
        <span className="bg-green-600 text-white py-3 px-4 rounded-r-lg shadow-lg flex items-center gap-2 transform transition-transform duration-300 group-hover:-translate-x-1">
          <svg
          ...
          <span className="font-semibold">01065690807</span>
        </span>
        <div className="w-2 h-full bg-green-700 rounded-r transform origin-left transition-transform duration-300 group-hover:scale-y-110"></div>
      </a>

      <button onClick={openWhatsApp} className="group flex items-center">
        <span className="bg-[#25D366] text-white py-3 px-4 rounded-r-lg shadow-lg flex items-center gap-2 transform transition-transform duration-300 group-hover:-translate-x-1">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
            fill="currentColor"
        ...
        <div className="w-2 h-full bg-[#128C7E] rounded-r transform origin-left transition-transform duration-300 group-hover:scale-y-110"></div>
      </button>
    </div>
  );
};

...
export const companyInfo = {
  ...
  about:
    "شركه متخصصه في توريد وتركيب جميع انظمه الطاقه الشمسيه في جميع محافظات جمهوريه مصر العربيه. حيث قامت بتنفيذ مشاريع كثيره منذ 2015 لتشغيل الابار وتعمل في كافه القطاعات مثل القطاع الزراعي والصناعي والسكني",
...
export const completedProjects = [
  ...
  },
  {
    ...
    location: "البحيره - وادي النطرون - المجابرة بجوار شركه الوطنيه للدواجن",
